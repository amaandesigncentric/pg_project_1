    ...
    try {
      ...
      const updates = assignments
        ...
        .map(assignment => {
          ...
          const newProduction = assignment.todayQty - stockUsed;
      ...
      const response = await axios.patch('https://pg-backend-o05l.onrender.com/api/bottles/update-progress', {
