                      ...
                      {departmentItems.map((dept) => (
                        <div key={dept.id}>
                          <button
                            ...
                            className={`w-full flex items-center justify-between px-2 py-1.5 text-xs font-medium rounded transition-all duration-200 ${activeMenuItem === dept.id || (dept.id === 'decoration' && isDecorationSubActive)
                              ? 'text-orange-700 bg-orange-100'
                              : 'text-gray-500 hover:text-orange-600 hover:bg-orange-50'
                              }`}
                          >
